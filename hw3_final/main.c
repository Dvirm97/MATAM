...
void test1_again(FILE *f1) {
    ...
    assert(a);
    assert(mtmFlixAddSeries(a, "s 1", 5, DRAMA, {20, 80}, 20) == MTMFLIX_ILLEGAL_SERIES_NAME);
    assert(mtmFlixAddSeries(a, "s1", 0, DRAMA, {20, 80} 20) == MTMFLIX_ILLEGAL_EPISODES_NUM);
    assert(mtmFlixAddSeries(a, "s1", 5, DRAMA, {20, 80}, 0) == MTMFLIX_ILLEGAL_EPISODES_DURATION);
    assert(mtmFlixAddSeries(a, "s 1", -5, DRAMA, {20, 80}, -5) == MTMFLIX_ILLEGAL_SERIES_NAME);
    assert(mtmFlixAddSeries(a, "s1", 5, SCIENCE_FICTION, {20, 80}, 20) == MTMFLIX_SUCCESS);
...
void test3_again(FILE *f1) {
    ...
    assert(mtmFlixAddSeries(a, "s4", 5, ROMANCE, {22, 55}, 20) == MTMFLIX_SUCCESS);
...
void finalCheck() {
    ...
    //char* output = readFile("./OutputFileFromTest");
    //printf("\noutput:\n%s\n",output);
